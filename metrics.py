...
def sim_matrix_inference_stochastic(text_embeds_per_video_id, vid_embeds_pooled_per_video_id, pooling_type):
  ...
  # num_txts, num_vids, max_text_per_vid, embed_dim = text_embeds_per_video_id.shape  # [1000, 1000, 1, 512]
  num_vids, num_txts, max_text_per_vid, embed_dim = text_embeds_per_video_id.shape

  vid_embeds_pooled_per_video_id = vid_embeds_pooled_per_video_id.permute(1, 2, 3, 0) # [num_txts, 1, 512, num_vids]
  vid_embeds_pooled_per_video_id = vid_embeds_pooled_per_video_id.reshape(num_txts * max_text_per_vid, embed_dim, num_vids)
  text_embeds_per_video_id = text_embeds_per_video_id.permute(0, 2, 1, 3) # [num_vids, 1, num_txts, embed_dim]
